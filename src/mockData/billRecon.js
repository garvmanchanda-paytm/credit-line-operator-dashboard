...
export const ingestionAlerts = [
  {
    ...
    healthReport: {
      ...
      productSpoc: 'finance-ops@company.com',
      techSpoc: 'data-eng@company.com',
      sloMinutes: 240,
      totalFields: 42,
      activeFields: 42,
      inactiveFields: 0,
  ...
  },
  {
    ...
    frequency: 'Daily',
    lastIngestion: 'N/A',
    alertType: 'Job Status Inactive',
    status: 'Failed',
    healthReport: {
      overallHealth: 0,
      pipelineStatus: 'Inactive',
      alertLabel: 'Alert: Job Status Inactive',
      alertDesc: 'Internal ingestion configuration or pipeline is unexpectedly set to INACTIVE. Service down.',
      inactivityReason: 'Pipeline inactive.',
      syncDelay: 'N/A',
      lastSyncTime: 'N/A',
      datasetMaxDate: null,
      sourceMaxDate: null,
  ...
  },
  {
    ...
    frequency: 'Monthly',
    lastIngestion: 'N/A',
    alertType: 'Missing Source File',
    status: 'Failed',
    healthReport: {
      overallHealth: 0,
      pipelineStatus: 'Inactive',
      alertLabel: 'Alert: Missing Source File',
      alertDesc: 'No source file detected at the SFTP location. SLA breached. Await lender upload.',
      inactivityReason: 'Source file not found.',
      syncDelay: 'N/A',
      lastSyncTime: 'N/A',
      datasetMaxDate: null,
      sourceMaxDate: null,
  ...
  },
  {
    ...
    dwhTable: 'ssfb_paytm.account_details_append_snapshot_v3',
    frequency: 'Daily',
    lastIngestion: 'Feb 18, 2026, 09:36:00',
    alertType: 'Ingestion Stall',
    status: 'Warning',
    healthReport: {
      overallHealth: 65,
      pipelineStatus: 'Active',
      alertLabel: 'Alert: Ingestion Stall',
      alertDesc: 'Source file is present at SFTP, but the ingestion job has not run or failed to consume it. Check DWH queue.',
      inactivityReason: null,
      syncDelay: '3.6h',
      lastSyncTime: 'Feb 18, 2026, 09:36:00',
      datasetMaxDate: '2026-02-17',
      sourceMaxDate: '2026-02-18',
  ...
  {
    id: 'ing-5',
    lenderFile: 'Daily Disbursement file',
    dwhTable: 'ssfb_paytm.daily_disbursement_v3',
    frequency: 'Daily',
    lastIngestion: 'N/A',
    alertType: 'Date Mismatch',
    status: 'Failed',
    healthReport: {
      overallHealth: 0,
      pipelineStatus: 'Active',
      alertLabel: 'Alert: Date Mismatch',
      alertDesc: 'Source file date header does not match expected ingestion date. Possible stale file re-upload.',
      inactivityReason: 'Date validation failed.',
      syncDelay: 'N/A',
      lastSyncTime: 'N/A',
      datasetMaxDate: null,
      sourceMaxDate: null,
      datasetId: 'ssfb_daily_disbursement_v3',
      type: 'INGEST',
      vertical: 'Lending',
      subVertical: 'Postpaid',
      productSpoc: 'finance-ops@company.com',
  ...
  {
    id: 'ing-6',
    lenderFile: 'Historical corrections',
    dwhTable: 'ssfb_paytm.historical_corrections_v3',
    frequency: 'Daily',
    lastIngestion: 'Feb 18, 2026, 05:15:00',
    alertType: 'Data Anomaly Detected',
    status: 'Warning',
    healthReport: {
      overallHealth: 72,
      pipelineStatus: 'Active',
      alertLabel: 'Alert: Data Anomaly Detected',
      alertDesc: 'Incorrect back-dated data detected in recent payload. Manual intervention required: Delete SFTP file, remove DB records, and re-ingest.',
      inactivityReason: null,
      syncDelay: '1.2h',
      lastSyncTime: 'Feb 18, 2026, 05:15:00',
      datasetMaxDate: '2026-02-17',
      sourceMaxDate: '2026-02-18',
      datasetId: 'ssfb_historical_corrections_v3',
      type: 'INGEST',
      vertical: 'Lending',
      subVertical: 'Postpaid',
      productSpoc: 'finance-ops@company.com',
...
// ── DPD LAN-level breakdown ──
export const dpdLanBreakdown = {
  61: [
    { paytmLan: 'PTM_DPD_2001', lenderLan: 'AB_DPD_2001', availableIn: 'Only in Paytm LMS', dpdCounter: 61 },
    { paytmLan: 'PTM_DPD_2002', lenderLan: 'AB_DPD_2002', availableIn: 'Only in Lender File', dpdCounter: 61 },
    { paytmLan: 'PTM_DPD_2003', lenderLan: 'AB_DPD_2003', availableIn: 'Mismatch in Both', dpdCounter: 61 },
    { paytmLan: 'PTM_DPD_2004', lenderLan: 'AB_DPD_2004', availableIn: 'Only in Paytm LMS', dpdCounter: 61 },
    { paytmLan: 'PTM_DPD_2005', lenderLan: 'AB_DPD_2005', availableIn: 'Only in Lender File', dpdCounter: 61 },
    { paytmLan: 'PTM_DPD_2006', lenderLan: 'AB_DPD_2006', availableIn: 'Mismatch in Both', dpdCounter: 61 },
    { paytmLan: 'PTM_DPD_2007', lenderLan: 'AB_DPD_2007', availableIn: 'Only in Paytm LMS', dpdCounter: 61 },
    { paytmLan: 'PTM_DPD_2008', lenderLan: 'AB_DPD_2008', availableIn: 'Only in Lender File', dpdCounter: 61 },
    { paytmLan: 'PTM_DPD_2009', lenderLan: 'AB_DPD_2009', availableIn: 'Mismatch in Both', dpdCounter: 61 },
    { paytmLan: 'PTM_DPD_2010', lenderLan: 'AB_DPD_2010', availableIn: 'Only in Paytm LMS', dpdCounter: 61 },
  ],
  45: [
    { paytmLan: 'PTM_DPD_3001', lenderLan: 'AB_DPD_3001', availableIn: 'Only in Paytm LMS', dpdCounter: 45 },
    { paytmLan: 'PTM_DPD_3002', lenderLan: 'AB_DPD_3002', availableIn: 'Mismatch in Both', dpdCounter: 45 },
    { paytmLan: 'PTM_DPD_3003', lenderLan: 'AB_DPD_3003', availableIn: 'Only in Lender File', dpdCounter: 45 },
    { paytmLan: 'PTM_DPD_3004', lenderLan: 'AB_DPD_3004', availableIn: 'Only in Paytm LMS', dpdCounter: 45 },
    { paytmLan: 'PTM_DPD_3005', lenderLan: 'AB_DPD_3005', availableIn: 'Mismatch in Both', dpdCounter: 45 },
    { paytmLan: 'PTM_DPD_3006', lenderLan: 'AB_DPD_3006', availableIn: 'Only in Lender File', dpdCounter: 45 },
    { paytmLan: 'PTM_DPD_3007', lenderLan: 'AB_DPD_3007', availableIn: 'Only in Paytm LMS', dpdCounter: 45 },
    { paytmLan: 'PTM_DPD_3008', lenderLan: 'AB_DPD_3008', availableIn: 'Mismatch in Both', dpdCounter: 45 },
  ],
  30: [
    { paytmLan: 'PTM_DPD_4001', lenderLan: 'AB_DPD_4001', availableIn: 'Only in Paytm LMS', dpdCounter: 30 },
    { paytmLan: 'PTM_DPD_4002', lenderLan: 'AB_DPD_4002', availableIn: 'Only in Lender File', dpdCounter: 30 },
    { paytmLan: 'PTM_DPD_4003', lenderLan: 'AB_DPD_4003', availableIn: 'Mismatch in Both', dpdCounter: 30 },
    { paytmLan: 'PTM_DPD_4004', lenderLan: 'AB_DPD_4004', availableIn: 'Only in Paytm LMS', dpdCounter: 30 },
    { paytmLan: 'PTM_DPD_4005', lenderLan: 'AB_DPD_4005', availableIn: 'Only in Lender File', dpdCounter: 30 },
    { paytmLan: 'PTM_DPD_4006', lenderLan: 'AB_DPD_4006', availableIn: 'Mismatch in Both', dpdCounter: 30 },
    { paytmLan: 'PTM_DPD_4007', lenderLan: 'AB_DPD_4007', availableIn: 'Only in Paytm LMS', dpdCounter: 30 },
    { paytmLan: 'PTM_DPD_4008', lenderLan: 'AB_DPD_4008', availableIn: 'Only in Lender File', dpdCounter: 30 },
    { paytmLan: 'PTM_DPD_4009', lenderLan: 'AB_DPD_4009', availableIn: 'Mismatch in Both', dpdCounter: 30 },
    { paytmLan: 'PTM_DPD_4010', lenderLan: 'AB_DPD_4010', availableIn: 'Only in Paytm LMS', dpdCounter: 30 },
  ],
  15: [
    { paytmLan: 'PTM_DPD_5001', lenderLan: 'AB_DPD_5001', availableIn: 'Only in Paytm LMS', dpdCounter: 15 },
    { paytmLan: 'PTM_DPD_5002', lenderLan: 'AB_DPD_5002', availableIn: 'Only in Lender File', dpdCounter: 15 },
    { paytmLan: 'PTM_DPD_5003', lenderLan: 'AB_DPD_5003', availableIn: 'Mismatch in Both', dpdCounter: 15 },
    { paytmLan: 'PTM_DPD_5004', lenderLan: 'AB_DPD_5004', availableIn: 'Only in Paytm LMS', dpdCounter: 15 },
    { paytmLan: 'PTM_DPD_5005', lenderLan: 'AB_DPD_5005', availableIn: 'Only in Lender File', dpdCounter: 15 },
    { paytmLan: 'PTM_DPD_5006', lenderLan: 'AB_DPD_5006', availableIn: 'Mismatch in Both', dpdCounter: 15 },
  ],
};
